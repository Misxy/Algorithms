public class Graph {
    ...
    /*
    that in case the graph is weighted and a weight isn't provided
    we set the edge value to 0
    if isn't weighted to simply add 1
    * */
    ...
    /*
     * In case the graph isn't weighted and a weight is provided,
     * we simply ignore that and set the [source,destination] value to 1,
     * indicating that an edge does exist:*/
